module.exports = {
	...
	adminId: "635399541742632960", //- Replace UserId with the Discord ID of the admin of the bot
	...
	cookieSecret: "Sanchitha is epic", //- Cookie Secret
	website: "http://localhost:4200", //- without the / at the end
	// You need a lavalink server for this bot to work!!!!
	// Lavalink server; public lavalink -> https://lavalink-list.darrennathanael.com/; create one yourself -> https://darrennathanael.com/post/how-to-lavalink
	nodes: [
		{
			identifier: "Jirayu", //- Used for indentifier in stats commands.
			host: "lavalink.jirayu.net", //- The host name or IP of the lavalink server.
			port: 13592, // The port that lavalink is listening to. This must be a number!
	...
	presence: {
		...
		activities: [
			{
				name: "SHUBHAMOS", //- Status Text
				type: "LISTENING", //- PLAYING, WATCHING, LISTENING, STREAMING
			},
		],
	},
	iconURL: "https://c.tenor.com/GCs-_Rh-vJIAAAAC/tenor.gif", //- This icon will be in every embed's author field
};
